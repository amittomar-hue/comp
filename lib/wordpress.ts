...
const DEFAULTS = {
  ...
  stats: [
    { id: 1, value: '200+', label: 'Global Partnerships', icon: 'handshake' },
    { id: 2, value: '23%', label: 'Fortune 500 Companies Served', icon: 'building2' },
    { id: 3, value: '100+', label: 'Digital Transformations Delivered', icon: 'layers' },
    { id: 4, value: '1,200+', label: 'Workshops & Training Programs', icon: 'users' },
    { id: 5, value: '500,000+', label: 'Hires Delivered', icon: 'briefcase' },
    { id: 6, value: '12×', label: 'Inc. 5000 Recognition', icon: 'award' },
  ] as SiteStat[],

  clients: [
    { id: 1, name: 'Cognizant', logo: { url: '', alt: 'Cognizant' } },
    { id: 2, name: 'Manulife', logo: { url: '', alt: 'Manulife' } },
    { id: 3, name: 'NRG Energy', logo: { url: '', alt: 'NRG Energy' } },
    { id: 4, name: 'Morgan Stanley', logo: { url: '', alt: 'Morgan Stanley' } },
    { id: 5, name: 'Aon', logo: { url: '', alt: 'Aon' } },
    { id: 6, name: 'Freddie Mac', logo: { url: '', alt: 'Freddie Mac' } },
    { id: 7, name: 'Microsoft', logo: { url: '', alt: 'Microsoft' } },
    { id: 8, name: 'Amazon', logo: { url: '', alt: 'Amazon' } },
    { id: 9, name: 'UiPath', logo: { url: '', alt: 'UiPath' } },
    { id: 10, name: 'Adobe', logo: { url: '', alt: 'Adobe' } },
    { id: 11, name: 'EY', logo: { url: '', alt: 'EY' } },
    { id: 12, name: 'Deloitte', logo: { url: '', alt: 'Deloitte' } },
    { id: 13, name: 'Accenture', logo: { url: '', alt: 'Accenture' } },
    { id: 14, name: 'JPMorgan Chase', logo: { url: '', alt: 'JPMorgan Chase' } },
    { id: 15, name: 'Bank of America', logo: { url: '', alt: 'Bank of America' } },
    { id: 16, name: 'MetLife', logo: { url: '', alt: 'MetLife' } },
    { id: 17, name: 'AIG', logo: { url: '', alt: 'AIG' } },
    { id: 18, name: 'Humana', logo: { url: '', alt: 'Humana' } },
    { id: 19, name: 'CVS Health', logo: { url: '', alt: 'CVS Health' } },
    { id: 20, name: 'Johnson & Johnson', logo: { url: '', alt: 'Johnson & Johnson' } },
    { id: 21, name: 'Siemens', logo: { url: '', alt: 'Siemens' } },
    { id: 22, name: 'Honeywell', logo: { url: '', alt: 'Honeywell' } },
    { id: 23, name: 'L3Harris', logo: { url: '', alt: 'L3Harris' } },
    { id: 24, name: 'Leidos', logo: { url: '', alt: 'Leidos' } },
    { id: 25, name: 'SAIC', logo: { url: '', alt: 'SAIC' } },
  ] as ClientLogo[],

  awards: [
    { id: 1, title: 'SIA Fastest-Growing Staffing Firms', year: '2025', image: { url: '', alt: 'SIA Award' }, description: '10 Consecutive Years' },
    { id: 2, title: 'Great Place to Work — Women', year: '2025', image: { url: '', alt: 'GPTW Women' }, description: 'Certified 2025' },
    { id: 3, title: 'Great Place to Work Certified', year: '2025', image: { url: '', alt: 'GPTW Certified' } },
    { id: 4, title: 'Brandon Hall Group Gold', year: '2024', image: { url: '', alt: 'Brandon Hall' }, description: 'Excellence in Technology' },
    { id: 5, title: 'USPAACC Fast 100', year: '2024', image: { url: '', alt: 'USPAACC' }, description: 'Asian American Business' },
    { id: 6, title: 'Inc. 5000', year: '2024', image: { url: '', alt: 'Inc 5000' }, description: '12× Recognition' },
  ] as Award[],
